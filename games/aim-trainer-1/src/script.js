let targetSize = 100;
      ...
      const setSensitivity = (val) => (sensitivity = parseFloat(val));

      addEventListener("mousemove", (e) => {
        const dx = (innerWidth / 2 - e.clientX) * sensitivity;
        const dy = (innerHeight / 2 - e.clientY) * sensitivity;
        area.style.left = dx + "px";
        area.style.top = dy + "px";
      ...
      function gameOver() {
        ...
        document.getElementById("sensitivityResult").textContent =
